...
#ifndef VENDOR_LUCID_TOUCH_V1_0_TOUCHSCREENGESTURE_H
#define VENDOR_LUCID_TOUCH_V1_0_TOUCHSCREENGESTURE_H

#include <hidl/MQDescriptor.h>
#include <hidl/Status.h>
#include <vendor/lucid/touch/1.0/ITouchscreenGesture.h>
#include <map>
