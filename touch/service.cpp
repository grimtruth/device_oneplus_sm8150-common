...
#define LOG_TAG "vendor.lucid.biometrics.fingerprint.inscreen@1.0-service.oneplus_msmnile"
...
using ::vendor::lucid::touch::V1_0::ITouchscreenGesture;
using ::vendor::lucid::touch::V1_0::implementation::TouchscreenGesture;
